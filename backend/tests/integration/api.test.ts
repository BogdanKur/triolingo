...
vi.mock("../../src/modules/auth/auth.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/auth/auth.service.js")>(
...
vi.mock("../../src/modules/profile/profile.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/profile/profile.service.js")>(
...
vi.mock("../../src/modules/learning/learning.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/learning/learning.service.js")>(
...
vi.mock("../../src/modules/exercise/exercise.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/exercise/exercise.service.js")>(
...
vi.mock("../../src/modules/progress/progress.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/progress/progress.service.js")>(
...
vi.mock("../../src/modules/store/store.service.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/modules/store/store.service.js")>(
